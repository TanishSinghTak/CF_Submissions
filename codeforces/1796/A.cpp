...
signed main() {
    ...
    while(t--){
        ...
        string fb1 = "FBFFBFFBFB"; //FBF
        string fb2 = "BFFBFFBFBF"; //BFF
        string fb3 = "FFBFFBFBFF"; //FFB
        string fb4 = "FBFFBFBFFB"; //FBF
        string fb5 = "BFFBFBFFBF"; //BFF
        string fb6 = "FFBFBFFBFF"; //FFB
        string fb7 = "FBFBFFBFFB";//FBF
        string fb8 = "BFBFFBFFBF"; //BFB
